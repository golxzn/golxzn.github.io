...
GEOMETRY_INFO: {
	UNIFORM_BUFFER_LENGTH: 32,
},

MATERIAL_INFO: {
	UNIFORM_BUFFER_LENGTH: 10,
},
...
Object.defineProperties(SHADERS_COMMON.LIGHTING_INFO, {
	UNIFORM_BUFFER_LENGTH: {
		value:
			SHADERS_COMMON.LIGHTING_INFO.DIRECTIONAL.COMPONENTS_COUNT * SHADERS_COMMON.LIGHTING_INFO.DIRECTIONAL.MAX_COUNT +
